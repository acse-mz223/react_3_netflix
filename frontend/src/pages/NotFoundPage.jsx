  ...
  return (
    <div className='relative w-full h-screen text-white'>
      ...
      <div className='absolute w-full h-full top-0 left-0 flex p-5 md:p-20 flex-col justify-center items-center'>
        <div className='text-4xl md:text-7xl tracking-wide mb-5 text-center'>Page not found</div>
        <div className='text-md  md:text-xl tracking-wide mb-5 max-w-4xl font-extralight text-center'>Sorry, we cant find the page. You can explore home page to find more infos.</div>
