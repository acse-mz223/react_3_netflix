      ...
      <div className='relative hero-bg h-screen w-full'>
          ...
          <div className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 max-w-lg w-full bg-black/75 rounded-md p-18 mt-10 flex flex-col justify-center items-center shadow-md space-y-6'>
              ...
              <form className='space-y-6 w-full' onSubmit={submit}>
                  ...
                  <button type='submit' className='bg-red-600 text-white text-xl font-light py-3 w-full rounded-sm text-center animate-all duration-400 hover:bg-red-700 cursor-pointer' >Log in</button>
                  <p className='text-gray-400 flex justify-center text-xl font-light '>OR</p>
                  <button type="button" onClick={handleNav} className='bg-white/20 text-white text-xl font-light py-3 w-full rounded-sm text-center animate-all duration-400 hover:bg-white/15 cursor-pointer'>Sign up</button>
              </form>
          </div>
      </div>
    )
